   ...
   <section class="flex">
    ...
    <nav class="navbar navbar-expand-sm  navbar-dark">
      ...
      <div class="profile">
         ...
         <div class="flex-btn">
            <a href="../admin/register_admin.php" class="btn btn-outline-warning btn-lg">register</a>
            <a href="../admin/admin_login.php" class="btn btn-outline-warning btn-lg">login</a>
         </div>
